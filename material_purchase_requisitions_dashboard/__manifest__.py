# -*- coding: utf-8 -*-
{
    'name': 'Product/Material Purchase Requisitions with Comparison Dashboard',
    'version': '19.0.1.0.0',
    'sequence': -1,
    ...
    'data': [
        ...
        'views/requisition_history_view.xml',
        'views/rfq_wizard_view.xml',
        'views/rfq_zero_price_confirm_wizard.xml',
        'views/rfq_line_zero_price_confirm_wizard.xml',
        'views/hr_employee_view.xml',
        'views/hr_department_view.xml',
        'views/stock_picking_view.xml',
        'views/rfq_comparison_report_view.xml',
    ],
    'images': ['material_purchase_requisitions_dashboard/static/description/icon.png'],
    'qweb': [
        'static/src/xml/rfq_comp_dashboard.xml',
    ],
    'assets': {
        'web.assets_backend': [
            'material_purchase_requisitions_dashboard/static/src/js/rfq_comp_dashboard.js',
            'material_purchase_requisitions_dashboard/static/src/css/rfq_dashboard.css',
            'material_purchase_requisitions_dashboard/static/src/xml/rfq_comp_dashboard.xml',
        ],
    },
    'installable': True,
    'application': False,
